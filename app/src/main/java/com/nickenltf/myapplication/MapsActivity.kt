package com.nickenltf.myapplication
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        // Add a marker in Palagan and move the camera
        val Uty = LatLng(-7.747033, 110.355398)
        mMap.addMarker(
            MarkerOptions().position(Uty).title("Universitas Teknologi Yogyakarta").snippet(
                "Indonesia, Sleman, DIY, 55285"
            )
        )
